 ...
 * attoptions must contain the same number of elements as tupdesc, or be NULL.
 *
						 ...
						 ObjectAddress *typaddress)
{
		  ...
		  relkind == RELKIND_INDEX))
	{
		...
		TypeCreate(new_array_oid,	/* force the type's OID to this */
				   ...
				   InvalidOid,	/* typmodin procedure - none */
				   InvalidOid,	/* typmodout procedure - none */
				   InvalidOid,	/* array analyze procedure - none (falls back to std_typanalyze) */
 ...
 * (Everything else needed is handled by dependency.c.)
 */
void
