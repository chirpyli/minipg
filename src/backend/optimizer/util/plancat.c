...
/* GUC parameter */
int			constraint_exclusion = CONSTRAINT_EXCLUSION_ON;
 ...
 * dropped cols.
 *
 * We also support building a "physical" tlist for subqueries and
 * values lists, since the same optimization can occur in SubqueryScan and
 * ValuesScan nodes.
 */
List *
