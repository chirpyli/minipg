 ...
 *
 * amcmds.c
 *	  Access method name/OID lookup routines.
 *
 * minipg note: CREATE/DROP ACCESS METHOD have been cropped (the parser no
 * longer accepts them), so this file only keeps the lookups used by the
 * index and table AM selection code.
 *
