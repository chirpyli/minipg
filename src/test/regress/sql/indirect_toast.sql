...
-- minipg: PL/pgSQL removed. The original test additionally used a plpgsql
-- BEFORE ROW trigger (update_using_indirect) to force every tuple to be
-- indirect and re-ran the modification/visibility checks. That trigger-based
-- section is dropped; the basic-level indirect-toast checks above remain.
