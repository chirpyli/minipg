...
-- minipg: array_typanalyze 函数已不存在于 pg_proc，该交叉检查移除
...
-- minipg: pg_attribute 的 attinhcount / attislocal 已随继承裁剪而移除
...
-- minipg: interval、numeric、bit、varbit、regrole、txid_snapshot、
