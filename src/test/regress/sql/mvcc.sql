...
-- minipg: PL/pgSQL removed. The original DO block ran 100 iterations of
-- (insert 100 rows in a subtransaction, then roll back) to create dead index
-- tuples. Replicate with a psql-side loop of explicit subtransactions.
\set i 0
while :i < 100
    BEGIN;
