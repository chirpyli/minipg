...
WITH RECURSIVE t(n) AS (
    VALUES (1::numeric)
UNION
    SELECT n+1::numeric FROM t WHERE n < 100::numeric
)
SELECT sum(n) FROM t;
...
VALUES(FALSE);
CREATE OR REPLACE RULE y_rule AS ON INSERT TO y DO ALSO NOTHING;
WITH t AS (
	INSERT INTO y VALUES(0)
)
VALUES(FALSE);
CREATE OR REPLACE RULE y_rule AS ON INSERT TO y
  DO INSTEAD (INSERT INTO y VALUES(0); INSERT INTO y VALUES(0));
WITH t AS (
	INSERT INTO y VALUES(0)
)
VALUES(FALSE);
