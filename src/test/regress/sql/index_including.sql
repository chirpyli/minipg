...
INSERT INTO tbl_include_reg SELECT x, 2*x, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
...
INSERT INTO tbl_include_unique1 SELECT x, 2*x, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
...
INSERT INTO tbl_include_unique2 SELECT 1, 2, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
...
INSERT INTO tbl_include_pk SELECT 1, 2*x, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
...
INSERT INTO tbl_include_box SELECT 1, 2*x, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
...
INSERT INTO tbl_include_box_pk SELECT 1, 2, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
...
INSERT INTO tbl SELECT 1, 2, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
DROP TABLE tbl;
...
-- ensure that constraint works
INSERT INTO tbl SELECT 1, 2, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
INSERT INTO tbl SELECT 1, NULL, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
INSERT INTO tbl SELECT x, 2*x, NULL, NULL FROM (SELECT generate_series(1,300) AS x) AS _gs;
DROP TABLE tbl;
...
INSERT INTO tbl SELECT 1, 2, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
INSERT INTO tbl SELECT 1, NULL, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
INSERT INTO tbl SELECT x, 2*x, NULL, NULL FROM (SELECT generate_series(1,10) AS x) AS _gs;
DROP TABLE tbl;
 ...
 */
CREATE TABLE tbl (c1 int, c2 int, c3 int, c4 box);
INSERT INTO tbl SELECT x, 2*x, 3*x, box('4,4,4,4') FROM (SELECT generate_series(1,10) AS x) AS _gs;
