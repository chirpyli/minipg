...
setup
{
 CREATE TABLE room_reservation (room_id text, start_time timestamp with time zone, end_time timestamp with time zone, description text, CONSTRAINT room_reservation_pkey PRIMARY KEY (room_id, start_time));
