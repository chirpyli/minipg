...
/* minipg note: the parallel-sort metadata (the TapeShare struct, and the
 * shared-fileset arguments of LogicalTapeSetCreate/LogicalTapeFreeze) has
 * been cropped together with parallel query. */
