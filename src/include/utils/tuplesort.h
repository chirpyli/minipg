 ...
 * algorithm.
 *
 * minipg note: the parallel sort support (coordinated sorting across several
 * worker processes plus a leader) has been cropped together with the rest of
 * parallel query.
 *
...
/* minipg note: the parallel-sort coordination state (SortCoordinate /
