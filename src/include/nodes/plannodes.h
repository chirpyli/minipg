 ...
 *	   CustomScan node
 *
 * CustomScan's custom_exprs, custom_private, custom_scan_tlist, and
 * custom_relids fields describe expressions, private data, an optional tlist
 * describing the scan tuple, and RTIs generated by this scan respectively.
 *
